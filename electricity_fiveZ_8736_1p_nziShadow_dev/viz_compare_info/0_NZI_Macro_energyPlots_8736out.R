...
outLoc  <- "/viz_compare_info/0_resultsPlots_code/"
...
#p
ggsave ( paste (  case , outLoc , "nationalPrimaryEnergy" , "_hour" , ".png" , sep = "" ) , p , width = wdth , height = hgth , units = "px" )
write.csv ( HOR  , paste ( case , outLoc , "nationalPrimaryEnergy" , "_hour_gwh" , ".csv" , sep = "" ) , row.names = FALSE , na = "" )
...
#p
ggsave    ( paste (  case , outLoc , "nationalPrimaryEnergy" , "_week" , ".png" , sep = "" ) , p , width = wdth , height = hgth , units = "px" )
write.csv ( WEK  , paste ( case , outLoc , "nationalPrimaryEnergy" , "_week_gwh" , ".csv" , sep = "" ) , row.names = FALSE , na = "" )
...
#p
ggsave ( paste (  case , outLoc , "nationalElectricity" , "_hour" , ".png" , sep = "" ) , p , width = wdth , height = hgth , units = "px" )
write.csv ( HOR  , paste ( case , outLoc , "nationalElectricity" , "_hour_gwh" , ".csv" , sep = "" ) , row.names = FALSE , na = "" )
...
#p
ggsave    ( paste (  case , outLoc , "nationalElectricity" , "_type_week" , ".png" , sep = "" ) , p , width = wdth , height = hgth , units = "px" )
write.csv ( WEK  , paste ( case , outLoc , "nationalElectricity" , "_type_week_gwh" , ".csv" , sep = "" ) , row.names = FALSE , na = "" )
...
#p
ggsave    ( paste (  case , outLoc , "nationalElectricity" , "_region_week" , ".png" , sep = "" ) , p , width = wdth , height = hgth , units = "px" )
write.csv ( WEK  , paste ( case , outLoc , "nationalElectricity" , "_region_week_gwh" , ".csv" , sep = "" ) , row.names = FALSE , na = "" )
