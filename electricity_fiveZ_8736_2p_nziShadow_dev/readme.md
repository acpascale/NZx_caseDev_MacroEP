...
- Added "Biomass Waste" as subcommodity for power plants. Biomass unallocated in electricity only.
...
1. Update transmission and specs in support xlsx and in asset files
2. Make 288-hour branch of stable
2. Extend 288 to 18 period run 
3. Dissaggregate coal supply node
4. Extend 8760 to 5 period run, 
