...
setwd("C:/Users/apascale/OneDrive - Princeton University/Documents/GitHub/MacroEnergy.jl/nzi_dev/")
...
case    <- "electricity_fiveZ_8736_1p_nziShadow"
run     <- "results8760_20260320"
outhrs  <- 8736
...
#p
ggsave ( paste (  case , "/viz_compare_info/" , "nationalPrimaryEnergy" , "_hour" , ".png" , sep = "" ) , p , width = wdth , height = hgth , units = "px" )
write.csv ( HOR  , paste ( case , "/viz_compare_info/" , "nationalPrimaryEnergy" , "_hour_gwh" , ".csv" , sep = "" ) , row.names = FALSE , na = "" )
...
#p
ggsave    ( paste (  case , "/viz_compare_info/" , "nationalPrimaryEnergy" , "_week" , ".png" , sep = "" ) , p , width = wdth , height = hgth , units = "px" )
write.csv ( WEK  , paste ( case , "/viz_compare_info/" , "nationalPrimaryEnergy" , "_week_gwh" , ".csv" , sep = "" ) , row.names = FALSE , na = "" )
...
#p
ggsave ( paste (  case , "/viz_compare_info/" , "nationalElectricity" , "_hour" , ".png" , sep = "" ) , p , width = wdth , height = hgth , units = "px" )
write.csv ( HOR  , paste ( case , "/viz_compare_info/" , "nationalElectricity" , "_hour_gwh" , ".csv" , sep = "" ) , row.names = FALSE , na = "" )
...
#p
ggsave    ( paste (  case , "/viz_compare_info/" , "nationalElectricity" , "_type_week" , ".png" , sep = "" ) , p , width = wdth , height = hgth , units = "px" )
write.csv ( WEK  , paste ( case , "/viz_compare_info/" , "nationalElectricity" , "_type_week_gwh" , ".csv" , sep = "" ) , row.names = FALSE , na = "" )
...
#p
ggsave    ( paste (  case , "/viz_compare_info/" , "nationalElectricity" , "_region_week" , ".png" , sep = "" ) , p , width = wdth , height = hgth , units = "px" )
write.csv ( WEK  , paste ( case , "/viz_compare_info/" , "nationalElectricity" , "_region_week_gwh" , ".csv" , sep = "" ) , row.names = FALSE , na = "" )
